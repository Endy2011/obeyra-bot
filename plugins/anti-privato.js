export async function before(m, { isOwner, isRowner, isMods }) {
    ...
    // 🛡️ FIX CRASH: Optional chaining (?.) previene il crash se m.text è vuoto o undefined
    ...
    if (varebot.antiprivato && !isOwner && !isRowner && !isMods) {
        // Log estetico prima del confinamento dell'host
        let blockMsg = `
☠️ 𝗘 𝗥 𝗥 𝗢 𝗥  𝟰 𝟬 𝟰  // 𝘗𝘙𝘐𝘝𝘈𝘛𝘌_𝘓𝘖𝘊𝘒𝘋𝘖𝘞𝘕 ☠️
───────────────────────
⎔ 𝘚𝘺𝘴_𝘚𝘵𝘢𝘵𝗎𝗌: 𝘜𝘕𝘈𝘜𝘛𝘏𝘖𝘙𝘐𝘡𝘌𝘋_𝘋𝘔_𝘋𝘌𝘛𝘌𝘊𝘛𝘌𝘋
⎔ 𝘛𝘢𝘳𝘨𝘦𝘵_𝘏𝘰𝓼𝘵: @${m.sender.split('@')[0]}
⎔ 𝘚𝘺𝘴_𝘈𝘤𝘵𝘪𝘰𝘯: 𝘏𝘖𝘚𝘛_𝘉𝘓𝘖𝘊𝘒_𝘌𝘟𝘌𝘊𝘜𝘛𝘌𝘋
───────────────────────
...
_𝘚𝘺𝘴𝘵𝘦System 𝘸𝘪𝘭𝘭 𝘯𝘰𝘵 𝘳𝘦𝘉𝘰𝘰𝒕. 𝘌𝘯𝘫𝘰ย 𝘵𝘩𝗲 𝘤𝘩𝘢𝘰ˢ._`.trim();
        ...
        // Esecuzione blocco dell'utente sul server di rete
