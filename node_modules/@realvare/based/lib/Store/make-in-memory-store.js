...
exports.default = (config) => {
    ...
    const MAX_MESSAGES_PER_CHAT = config.maxMessagesPerChat || 50;
    const MAX_CHATS_WITH_MESSAGES = config.maxChatsWithMessages || 250;
    const MAX_CONTACTS = config.maxContacts || 2500;
    const MAX_GROUP_METADATA = config.maxGroupMetadata || 250;
    const MAX_PRESENCES = config.maxPresences || 100;
